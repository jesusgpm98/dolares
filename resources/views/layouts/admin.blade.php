              ...
              <div id="side-overlay-scroll">
                  ...
                  <div class="side-header side-content">
                      ...
                      <span>
                          ...
                          <span class="font-w600 push-10-l">George Stone</span>
                      </span>
                  </div>
                  <!-- END Side Header -->
                                          ...
                                          <ul class="nav-users remove-margin-b">
                                              ...
                                              <li>
                                                  <a href="base_pages_profile.html">
                                                      ...
                                                      <i class="fa fa-circle text-warning"></i> Ashley Welch
              ...
              <div id="sidebar-scroll">
                  ...
                  <div class="sidebar-content">
                      ...
                      <div class="side-content side-content-full">
                          <ul class="nav-main">
                              <li>
                                  <a href="base_pages_dashboard.html"><i class="si si-speedometer"></i><span class="sidebar-mini-hide">Inicio</span></a>
                              </li>
                              <li>
                                  <a class="active" href="base_pages_dashboard_v2.html"><i class="si si-rocket"></i><span class="sidebar-mini-hide">Usuarios</span></a>
                              </li>
                              <li>
                                  <a class="active" href="base_pages_dashboard_v2.html"><i class="si si-rocket"></i><span class="sidebar-mini-hide">Tickets</span></a>
                              </li>

                              <li>
                                  <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-badge"></i><span class="sidebar-mini-hide">Post</span></a>
                                  <ul>
                                    <li>
